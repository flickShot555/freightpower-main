...
### **AI Hub Assistant Docs**
👉 [docs/AI_HUB_ENDPOINTS.md](docs/AI_HUB_ENDPOINTS.md) - Role assistant endpoint reference  
👉 [docs/AI_HUB_FIRESTORE_MIGRATION.md](docs/AI_HUB_FIRESTORE_MIGRATION.md) - Firestore collection notes  
👉 [docs/AI_HUB_TELEMETRY_RUNBOOK.md](docs/AI_HUB_TELEMETRY_RUNBOOK.md) - Monitoring and incident runbook
